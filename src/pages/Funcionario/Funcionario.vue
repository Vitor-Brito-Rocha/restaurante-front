  <template>
    <div class="w-100 h-100 pr-4">
      ...
      <div class="h-75 w-100">
        <CommomTableList :data="items" :headers="headers" :permissoes="permissoes" :per-page="offset" :total-items="totalItems" :page="page" :loading="loadingTable" @verify="verifyGetFunction($event)" @deleteModal="deletarMesa($event)" @editModal="editViewModal" />
      </div>
